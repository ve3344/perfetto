...
exports.WattsonPackageSelectionAggregator = void 0;
const utils_1 = require("../../base/utils");
const query_result_1 = require("../../trace_processor/query_result");
const track_kinds_1 = require("../../public/track_kinds");
class WattsonPackageSelectionAggregator {
    id = 'wattson_package_aggregation';
    ...
    `);
        if (packageInfo.firstRow({ isValid: query_result_1.NUM }).isValid === 0)
            return false;
        const selectedCpus = [];
...
exports.WattsonPackageSelectionAggregator = WattsonPackageSelectionAggregator;
//# sourceMappingURL=package_aggregator.js.map