...
test('sql_column_id.basic', () => {
    ...
    expect((0, column_1.sqlColumnId)('utid')).toBe('utid');
});
test('sql_column_id.single_join', () => {
    expect((0, column_1.sqlColumnId)({
        column: 'bar',
        source: {
            table: 'foo',
            joinOn: {
...
test('sql_column_id.arg_set_id', () => {
    ...
    expect((0, column_1.sqlColumnId)((0, well_known_columns_1.argSqlColumn)('arg_set_id', 'arg1'))).toBe("arg_set_id['arg1']");
});
test('sql_column_id.arg_set_id_with_join', () => {
    // Special case: arg_set_id.
    expect((0, column_1.sqlColumnId)((0, well_known_columns_1.argSqlColumn)({
        column: 'arg_set_id',
        source: {
            table: 'foo',
            joinOn: {
    ...
    }, 'arg1'))).toBe("foo[x=y].arg_set_id['arg1']");
});
//# sourceMappingURL=column_unittest.js.map