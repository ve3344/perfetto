...
exports.ScrollTimelineTrack = void 0;
...
const sql_table_slice_track_details_tab_1 = require("../../components/tracks/sql_table_slice_track_details_tab");
...
class ScrollTimelineTrack extends named_slice_track_1.NamedSliceTrack {
    tableName;
    constructor(trace, uri) {
        super(trace, uri);
        this.tableName = `scrolltimelinetrack_${(0, string_utils_1.sqlNameSafe)(uri)}`;
    }
    async onInit() {
        await super.onInit();
        ...
        // scroll_steps).
        return await (0, sql_utils_1.createPerfettoTable)(this.engine, this.tableName, `WITH
        ...
        scroll_steps AS (${STEP_TEMPLATES.map((step) => `
          SELECT
            id AS scroll_id,
    ...
    detailsPanel(sel) {
        return new sql_table_slice_track_details_tab_1.SqlTableSliceTrackDetailsPanel(this.trace, this.tableName, sel.eventId);
    }
}
exports.ScrollTimelineTrack = ScrollTimelineTrack;
