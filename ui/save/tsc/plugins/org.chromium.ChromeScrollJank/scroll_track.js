...
exports.TopLevelScrollTrack = void 0;
...
class TopLevelScrollTrack extends custom_sql_table_slice_track_1.CustomSqlTableSliceTrack {
    getSqlDataSource() {
        return {
    ...
    detailsPanel(sel) {
        return new scroll_details_panel_1.ScrollDetailsPanel(this.trace, sel.eventId);
    }
}
exports.TopLevelScrollTrack = TopLevelScrollTrack;
