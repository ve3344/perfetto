...
exports.AndroidLogTrack = void 0;
...
class AndroidLogTrack {
    ...
    async onBoundsChange(start, end, resolution) {
      ...
      order by tsQuant, prio limit ${track_data_1.LIMIT};`);
        ...
        const it = queryRes.iter({ tsQuant: query_result_1.LONG, prio: query_result_1.NUM, numEvents: query_result_1.NUM });
    ...
    render({ ctx, size, timescale }) {
        ...
        const quantWidth = Math.max(EVT_PX, timescale.durationToPx(data.resolution));
...
exports.AndroidLogTrack = AndroidLogTrack;
