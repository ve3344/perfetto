...
class ChromeCategoriesSelection {
    recState;
    defaultCategoryOptions = undefined;
    disabledByDefaultCategoryOptions = undefined;
    constructor({ attrs }) {
        this.recState = attrs.recState;
    }
    updateValue(attrs, diffs) {
    ...
    view({ attrs }) {
        ...
        if (this.defaultCategoryOptions === undefined ||
            ...
            // Chrome.
            const enabled = new Set(categoryConfigGetter.get(this.recState.recordConfig));
            let categories = attrs.recState.chromeCategories ||
                extractChromeCategories(attrs.dataSources);
            if (!categories || !(0, state_1.isChromeTarget)(attrs.recState.recordingTarget)) {
                categories = (0, state_1.getBuiltinChromeCategoryList)();
            }
            ...
            categories.forEach((cat) => {
                ...
                else if (!cat.startsWith(disabledPrefix) &&
        ...
        return (0, mithril_1.default)('div.chrome-categories', (0, mithril_1.default)(section_1.Section, { title: 'Additional Categories' }, (0, mithril_1.default)(multiselect_1.MultiSelect, {
        ...
        })), (0, mithril_1.default)(section_1.Section, { title: 'High Overhead Categories' }, (0, mithril_1.default)(multiselect_1.MultiSelect, {
...
class ChromeSettings {
    view({ attrs }) {
        ...
        return (0, mithril_1.default)(`.record-section${attrs.cssClass}`, (0, record_widgets_1.CompactProbe)({
            title: 'Task scheduling',
            setEnabled: (cfg, val) => (cfg.taskScheduling = val),
            isEnabled: (cfg) => cfg.taskScheduling,
            recCfg,
        }), (0, record_widgets_1.CompactProbe)({
            title: 'IPC flows',
...
//# sourceMappingURL=chrome_settings.js.map