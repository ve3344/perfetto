...
exports.targetFactoryRegistry = exports.TargetFactoryRegistry = void 0;
const registry_1 = require("../../../base/registry");
class TargetFactoryRegistry extends registry_1.Registry {
    listTargets() {
        const targets = [];
...
exports.TargetFactoryRegistry = TargetFactoryRegistry;
exports.targetFactoryRegistry = new TargetFactoryRegistry((f) => {
    return f.kind;
});
//# sourceMappingURL=target_factory_registry.js.map