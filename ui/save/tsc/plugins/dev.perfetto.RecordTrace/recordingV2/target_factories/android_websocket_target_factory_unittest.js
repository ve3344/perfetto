...
const android_websocket_target_factory_1 = require("./android_websocket_target_factory");
test('parse device disconnection', () => {
    const message = '001702121FQC20XXXX\toffline\n';
    const response = (0, android_websocket_target_factory_1.parseWebsocketResponse)(message);
...
//# sourceMappingURL=android_websocket_target_factory_unittest.js.map