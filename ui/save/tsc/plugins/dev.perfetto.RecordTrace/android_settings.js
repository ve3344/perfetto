...
const PUSH_ATOM_IDS = new Map();
const PULL_ATOM_IDS = new Map();
for (const key in protos_1.AtomId) {
    if (!Object.hasOwn(protos_1.AtomId, key))
        continue;
    const value = Number(protos_1.AtomId[key]);
    if (!isNaN(value)) {
...
const DEFAULT_ATRACE_CATEGORIES = new Map();
...
class AtraceAppsList {
    view({ attrs }) {
        if (attrs.recCfg.allAtraceApps) {
            return (0, mithril_1.default)('div');
        }
        return (0, mithril_1.default)(record_widgets_1.Textarea, {
...
class AndroidSettings {
    view({ attrs }) {
        ...
        return (0, mithril_1.default)(`.record-section${attrs.cssClass}`, (0, mithril_1.default)(record_widgets_1.Probe, {
            ...
            recCfg,
        }), (0, mithril_1.default)(AtraceAppsList, { recCfg })), (0, mithril_1.default)(record_widgets_1.Probe, {
...
//# sourceMappingURL=android_settings.js.map