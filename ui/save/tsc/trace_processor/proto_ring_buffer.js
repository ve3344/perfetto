...
class ProtoRingBuffer {
    ...
    append(data) {
        (0, logging_1.assertTrue)(this.wr <= this.buf.length);
        (0, logging_1.assertTrue)(this.rd <= this.wr);
        ...
        if (dataLen === 0)
            return;
        (0, logging_1.assertTrue)(this.fastpath === undefined);
        if (this.rd === this.wr) {
        ...
        if (dataLen > avail) {
            ...
            if (dataLen > avail) {
                ...
                (0, logging_1.assertTrue)(newSize <= kMaxMsgSize * 2);
    ...
    readMessage() {
        ...
        if (msg === undefined)
            return undefined;
        (0, logging_1.assertTrue)(msg.buffer === this.buf.buffer);
        (0, logging_1.assertTrue)(this.buf.byteOffset === 0);
    ...
    static tryReadMessage(data, dataStart, dataEnd) {
        (0, logging_1.assertTrue)(dataEnd <= data.length);
        let pos = dataStart;
        if (pos >= dataEnd)
            return undefined;
...
//# sourceMappingURL=proto_ring_buffer.js.map