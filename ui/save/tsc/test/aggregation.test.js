...
(0, test_1.test)('gpu counter', async () => {
    await page.keyboard.press('Escape');
    const gpuTrack = pth.locateTrack('Gpu 0 Frequency');
    const coords = (0, logging_1.assertExists)(await gpuTrack.boundingBox());
...
(0, test_1.test)('frametimeline', async () => {
    await page.keyboard.press('Escape');
    ...
    const actualTimeline = pth.locateTrack('com.android.systemui 25348/Actual Timeline', sysui);
    const coords = (0, logging_1.assertExists)(await actualTimeline.boundingBox());
    await page.mouse.move(600, coords.y + 10);
    await page.mouse.down();
...
(0, test_1.test)('slices', async () => {
    ...
    await pth.waitForPerfettoIdle();
    const coords = (0, logging_1.assertExists)(await animThread.boundingBox());
    await page.mouse.move(600, coords.y + 10);
    await page.mouse.down();
    await page.mouse.move(1000, coords.y + 20);
    await page.mouse.up();
