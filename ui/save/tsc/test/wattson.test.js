...
(0, test_1.test)('wattson aggregations', async () => {
    ...
    const coords = (0, logging_1.assertExists)(await cpuEstimate.boundingBox());
...
(0, test_1.test)('sched aggregations', async () => {
    await page.keyboard.press('Escape');
...
//# sourceMappingURL=wattson.test.js.map