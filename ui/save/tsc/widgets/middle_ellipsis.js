...
class MiddleEllipsis {
    view({ attrs, children }) {
        ...
        return (0, mithril_1.default)('.pf-middle-ellipsis', (0, mithril_1.default)('span.pf-middle-ellipsis-left', replaceLeadingTrailingSpacesWithNbsp(left)), (0, mithril_1.default)('span.pf-middle-ellipsis-right', replaceLeadingTrailingSpacesWithNbsp(right)), children);
    }
}
