...
exports.HighPrecisionTimeSpan = void 0;
 ...
 */
class HighPrecisionTimeSpan {
    static ZERO = new HighPrecisionTimeSpan(high_precision_time_1.HighPrecisionTime.ZERO, 0);
    start;
    duration;
    ...
    static fromTime(start, end) {
        return new HighPrecisionTimeSpan(new high_precision_time_1.HighPrecisionTime(start), Number(end - start));
    }
    /**
     ...
     */
    pad(time) {
        return new HighPrecisionTimeSpan(this.start.subNumber(time), this.duration + 2 * time);
    }
    /**
    ...
    fitWithin(start, end) {
        ...
        if (this.start.integral < start) {
            ...
            return new HighPrecisionTimeSpan(new high_precision_time_1.HighPrecisionTime(start), this.duration);
        }
        if (this.end.gt(end)) {
            // Current span ends after limits
            return new HighPrecisionTimeSpan(new high_precision_time_1.HighPrecisionTime(end).subNumber(this.duration), this.duration);
        }
        return this;
    }
    /**
     ...
     */
    toTimeSpan() {
        return new time_1.TimeSpan(this.start.toTime('floor'), this.end.toTime('ceil'));
    }
}
exports.HighPrecisionTimeSpan = HighPrecisionTimeSpan;
//# sourceMappingURL=high_precision_time_span.js.map