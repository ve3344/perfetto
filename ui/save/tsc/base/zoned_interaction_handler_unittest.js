...
const zoned_interaction_handler_1 = require("./zoned_interaction_handler");
describe('ZonedInteractionHandler', () => {
    ...
    beforeEach(() => {
        ...
        zih = new zoned_interaction_handler_1.ZonedInteractionHandler(div);
    });
    ...
    function simulateMouseEvent(kind, x, y) {
        div.dispatchEvent(new MouseEvent(kind, {
            bubbles: true,
            clientX: x,
            clientY: y,
        }));
...
//# sourceMappingURL=zoned_interaction_handler_unittest.js.map